  ...
  <view>
        ...
        <view class="ware-item">
          ...
          <div class="ware-content">
            ...
            <view class="ware-image">
              <image
                src="https://img.alicdn.com/imgextra/i1/2536908852/TB2PZ9rpstnpuFjSZFKXXalFFXa_!!2536908852-0-beehive-scenes.jpg_360x360xzq90.jpg"
                mode="aspectFill"
              ></image>
            </view>
            <!-- 2.0.5 商品信息 -->
            <view class="ware-info">
              <view class="ware-info-title">商品标题</view>
              <div class="ware-info-btm">
                <view class="ware-price">￥ 999</view>
                <div class="calculate">
                  <div class="rect">-</div>
    ...
    <div class="cart-total">
      ...
      <view class="total-center">
        <view>合计:
          <text class="color-red">￥ 999</text>
        </view>
        <div class="price-tips">包含运费</div>
      </view>
      <view class="accounts">结算(3)</view>
    </div>
  </view>
</template>
<script>
